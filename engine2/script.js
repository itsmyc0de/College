...
// http://javascript-source.com
//***********************************************
jQuery("#wowslider-container2").wowSlider({effect:"blinds",prev:"",next:"",duration:20*100,delay:20*100,width:598,height:255,autoPlay:true,autoPlayVideo:false,playPause:false,stopOnHover:false,loop:false,bullets:1,caption:false,captionEffect:"parallax",controls:false,controlsThumb:["data2/tooltips/slide1.png", "data2/tooltips/slides2.png", "data2/tooltips/slides3.png"],responsive:1,fullScreen:false,gestures:2,onBeforeStep:0,images:0});